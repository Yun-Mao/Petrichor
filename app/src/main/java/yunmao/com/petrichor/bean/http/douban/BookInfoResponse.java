package yunmao.com.petrichor.bean.http.douban;

import yunmao.com.petrichor.bean.BookRatingBean;
import yunmao.com.petrichor.bean.ImageBean;
import yunmao.com.petrichor.bean.SeriesBean;
import yunmao.com.petrichor.bean.BookTagBean;
...
public class BookInfoResponse implements Serializable {
    public static final long serialVersionUID = 7060254125600464481L;//序列化机制识别码
    public static final String serialVersionName = "bookInfo";//序列化机制名称
    private String id;
