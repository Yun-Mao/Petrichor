...
import yunmao.com.petrichor.holder.SearchViewHolder;
import yunmao.com.petrichor.ui.fragment.BaseFragment;
import yunmao.com.petrichor.ui.fragment.BookReadFragment;
import yunmao.com.petrichor.ui.fragment.BookshelfFragment;
import yunmao.com.petrichor.ui.fragment.HomeFragment;
import yunmao.com.petrichor.ui.fragment.NotesFragment;
import yunmao.com.petrichor.ui.fragment.PhotoFragment;
import yunmao.com.petrichor.ui.fragment.ManageFragment;
import yunmao.com.petrichor.utils.common.KeyBoardUtils;
import yunmao.com.petrichor.utils.common.PermissionUtils;
import yunmao.com.petrichor.utils.common.SPUtils;
import yunmao.com.petrichor.utils.common.ScreenUtils;
import yunmao.com.petrichor.utils.customtabs.CustomTabActivityHelper;
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener{
    private static final int EXIT_APP_DELAY = 1000;//按返回键确定是否退出
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            currentFragment = PhotoFragment.newInstance();
    ...
    private void initNavView() {
        ...
        mNavigationView.getMenu().findItem(R.id.nav_photo).setChecked(true);
    ...
    public void onBackPressed() {
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            if (!(currentFragment instanceof PhotoFragment)) {
                switchContent(currentFragment, PhotoFragment.newInstance());
                mNavigationView.getMenu().findItem(R.id.nav_photo).setChecked(true);
                return;
            }
    ...
    public void setFab(FloatingActionButton fab) {
        ...
        mFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                data.setData(Uri.parse("mailto:13325803302@126.com"));
                startActivity(data);
            }
        });
    }
...
//                mPopupWindow.setAnimationStyle(R.style.PopupWindowStyle);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            switchContent(currentFragment, NotesFragment.newInstance());
        } else if (id == R.id.nav_bookshelf) {
            switchContent(currentFragment, BookshelfFragment.newInstance());
        } else if (id == R.id.nav_manage) {
            switchContent(currentFragment, BookReadFragment.newInstance());
